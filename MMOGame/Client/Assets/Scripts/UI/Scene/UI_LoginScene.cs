...
public class UI_LoginScene : UI_Scene
{
    ...
    public void OnClickCreateButton(PointerEventData evt)
    {
        ...
        {
            string createResult = res.CreateOk ? "Create Character" : "Create Failed";
            Debug.Log(createResult);
    ...
    public void OnClickLoginButton(PointerEventData evt)
    {
        ...
        {
            string loginResult = res.LoginOk ? "Login was successful" : "Login was Failed";
